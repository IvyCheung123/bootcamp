...
public class AppConfig {
  ...
  @Bean
  RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory factory, ObjectMapper redisObjectMapper) {
  ...
  @Bean
  RedisHelper redisProfileHelper(RedisConnectionFactory factory, ObjectMapper redisObjectMapper) {
